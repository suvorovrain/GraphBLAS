...
\item May 20, 2025: version 10.1.0
    ...
    \item \verb'GxB_STDC_VERSION': this is normally equal to
        ...
        If it is $\ge$ 2011012L, then C11 is being used and the polymorphic
        ...
        199001L to denote C90 (and no \verb'_Generic' keyword is used).  See
        \verb'GraphBLAS/Demo/Include/graphblas_demo.h' for an example usage.
    \end{itemize}
