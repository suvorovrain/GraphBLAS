...
\item FIXME, 2025: version 10.0.3

    \begin{itemize}
    \item upgrade \verb'xxHash' to 0.8.3: contributed by Christoph Gr\"uninger.
    \item upgrade \verb'cpu_features' to 0.9.0: contributed by Christoph Gr\"uninger.
    \item Octave interface: revised for the recent MacOS (15.3.2), assuming that
